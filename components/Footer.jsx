    ...
    <footer className='shadow-md w-full bottom-0 bg-slate-900 text-gray-100 md:px-10'>
      ...
      <div className='flex md:flex-row flex-col gap-4 items-center justify-between md:px-16 px-5 pb-4 '>
        <span className='text-gray-300 font-semibold'>
          © 2023 Get in Couch, Inc. All rights reserved.
        </span>
        <span className='text-gray-300 font-semibold'>
          Made with ❤️ by <Link href='https://www.github.com/IsmaelP19' className=' hover:text-[#0099ff] duration-100 hover:underline'>Ismael</Link>
        </span>
      </div>
